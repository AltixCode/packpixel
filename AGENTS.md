# PackPixel — Agent Runbook & Operating Directive

## 1. System Overview & Identifiers
* **App Name:** PackPixel
* **Bundle Identifier (iOS):** `com.hushtunnel.packpixel`
* **Package Name (Android):** `com.hushtunnel.packpixel`
* **URL Scheme:** `packpixel://`
...
* `https://www.hushtunnel.com/legal/packpixel-privacy`
* `https://www.hushtunnel.com/legal/packpixel-terms`
