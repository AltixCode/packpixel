...
const TRACKING_PURPOSE =
  'This lets PackPixel show ads that are more relevant to you. Your images are never uploaded, your data is never sold, and the app works exactly the same either way.';
...
export default ({ config }: ConfigContext): ExpoConfig => {
  ...
  return {
    ...config,
    name: config.name ?? 'PackPixel',
    slug: config.slug ?? 'packpixel',
    plugins: [
      ...basePlugins,
      [
